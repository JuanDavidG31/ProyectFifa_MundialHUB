...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
	...
	public void registerStompEndpoints(StompEndpointRegistry registry) {
		// El endpoint al que se conectará Angular
		registry.addEndpoint("/ws").setAllowedOrigins("http://localhost:4200") // Permite a Angular
				.withSockJS(); // Soporte de retrocompatibilidad
	}

	// INTERCEPTOR PARA SEGURIDAD JWT EN WEBSOCKETS
	@Override
                    ...
                    if (authHeader != null && authHeader.startsWith("Bearer ")) {
                        ...
                        if (encryptedUsername != null) {
                            ...
                            if (jwtUtil.validateToken(token, userDetails)) {
                                ...
                                // ¡NUEVO RADAR DE SEGURIDAD!
                                System.out.println("🟢 [WEBSOCKET AUTH] Túnel seguro abierto para el usuario: [" + cleanUsername + "]");
